...
.config(function($stateProvider,$urlRouterProvider){
  ...
  .state('home',{
    ...
    .state('graphform',{
      url:'/graphform',
      templateUrl:'templates/graphform.html',
      controller:'graphformCtrl'
    })
    .state('map',{
      url:'/map',
...
.controller('graphformCtrl',['$scope','$state',function($scope,$state){

        $scope.master = {};

        $scope.update = function(user){
          $scope.master = angular.copy(graph);
        }
...
.controller('researchCtrl',['$scope','$http',function($scope,$http){
